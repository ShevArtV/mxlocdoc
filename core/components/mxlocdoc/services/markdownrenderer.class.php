 ...
 * @package mxlocdoc
 */
class mxLocDocMarkdownRenderer
{
    /** @var modX */
    protected $modx;
    ...
    public function __construct(modX &$modx, mxLocDoc $mxlocdoc, mxLocDocAssetRepository $assetRepository)
    {
        $this->modx =& $modx;
    ...
    protected function getParser()
    {
        ...
        $classPath = $this->mxlocdoc->config['core_path'] . 'vendor/parsedown/Parsedown.php';
